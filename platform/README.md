...
| global.redis.existingSecretName | string | `""` | Name of an existing secret containing credentials for Redis, in alternative to the password field. |
...
| redis.existingSecretName | string | `""` | Name of an existing secret containing credentials for Redis, in alternative to the password field. |
