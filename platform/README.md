...
![Version: 0.16.2](https://img.shields.io/badge/Version-0.16.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v25.2.3](https://img.shields.io/badge/AppVersion-v25.2.3-informational?style=flat-square)
...
```console
helm install my-release oci://public.cr.seqera.io/charts/platform --version 0.16.2 --namespace my-namespace --create-namespace
```
