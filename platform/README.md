...
| platform.YAMLConfigFileContent | string | `""` | Content to insert into the tower.yml file (you can use `\|-` YAML multilines) |
| platform.contactEmail | string | `"tower-support@example.com"` | Sender email address for user support. |
