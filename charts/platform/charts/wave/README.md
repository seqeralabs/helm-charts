...
![Version: 0.5.3](https://img.shields.io/badge/Version-0.5.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.37.0](https://img.shields.io/badge/AppVersion-v1.37.0-informational?style=flat-square)
...
1. Download the default values file:
   ```console
   helm show values oci://public.cr.seqera.io/charts/wave --version 0.5.3 > values.yaml
   ```
