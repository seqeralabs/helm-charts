...
- Support for `global.trustStore`, including a Java trust store that preserves public roots and
  imports every certificate from a private CA bundle.

## [0.5.1] - 2026-07-24

### Changed

- Bump wave image to `v1.37.0`.
