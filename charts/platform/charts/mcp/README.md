...
![Version: 0.7.1](https://img.shields.io/badge/Version-0.7.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.4.2](https://img.shields.io/badge/AppVersion-1.4.2-informational?style=flat-square)
...
- The MCP domain set at `.global.mcpDomain`, which defaults to the subdomain `mcp.<platformExternalDomain>`.
- The domain where Seqera Platform is accessible, set at `.global.platformExternalDomain`.
...
By default the chart selects the application images defined in the `appVersion` field of the `Chart.yaml` file, currently set as `1.4.2`.
...
1. Download the default values file:
   ```console
   helm show values oci://public.cr.seqera.io/charts/mcp --version 0.7.1 > values.yaml
   ```
