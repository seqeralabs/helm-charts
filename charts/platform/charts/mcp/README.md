...
| oidcToken.existingSecretKey | string | `"TOWER_OIDC_REGISTRATION_INITIAL_ACCESS_TOKEN"` | Key in the existing Secret containing the OIDC client registration token |
