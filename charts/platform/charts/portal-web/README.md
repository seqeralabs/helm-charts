...
| oauth.endpoint | string | `"{{ printf \"https://%s/api\" .Values.global.platformExternalDomain }}"` | OAuth endpoint. Evaluated as a template |
| oauth.clientId | string | `"seqera_ai_portal_web"` | OAuth web client ID |
| oauth.audience | string | `"platform"` | OAuth audience |
